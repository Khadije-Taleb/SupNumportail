<x-app-layout>
    <x-slot name="header">
        <div class="bg-gradient-to-r from-blue-700 to-indigo-600 py-6 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 shadow-lg">
            <h2 class="font-bold text-2xl text-white leading-tight">{{ __('Nouvelle évaluation') }}</h2>
        </div>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-xl border border-gray-100 dark:border-gray-700 p-6">
                ...
                <form action="{{ route('admin.evaluations.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="matiere" value="{{ old('matiere') }}" class="w-full border px-3 py-2 rounded" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="type_evaluation" value="{{ old('type_evaluation') }}" class="w-full border px-3 py-2 rounded" required>
